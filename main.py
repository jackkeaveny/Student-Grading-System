...
the_menu = {'T': 'Total grade', 'L': 'List', 'A': 'Add', 'U': 'Update', 'D': 'Delete', 'S': 'Save the data', 'R': 'Restore data from file', 'Q': 'Quit this program'}
opt = None
...
while True:
    ...
    if not (opt in the_menu): # TODO 3: check of the character stored in opt is in the_menu dictionary
